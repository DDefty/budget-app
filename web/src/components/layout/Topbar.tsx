    ...
    <header className="p-4 mb-2 bg-white">
      <div className='flex justify-between items-center gap-3 mb-2'>
        ...
        <nav className="flex gap-x-32 items-center">
          ...
          <NavLink to="/budgets" className={location.pathname === '/budgets' ? " focus:outline-none transition-colors disabled:opacity-50 bg-blue-600 hover:bg-blue-700 w-32 flex justify-center rounded-lg bg-primary/20 dark:bg-primary/30 py-2 px-4 text-l font-medium text-primary shadow-sm hover:bg-primary/30 dark:hover:bg-primary/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary" : "focus:outline-none transition-colors disabled:opacity-50 hover:bg-blue-300 w-32 flex justify-center rounded-lg py-2 px-4 text-l font-medium text-muted-light hover:text-primary shadow-sm hover:bg-primary/15 dark:hover:bg-primary/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"}>Budgets</NavLink>
          <NavLink to="/reports" className={location.pathname === '/reports' ? " focus:outline-none transition-colors disabled:opacity-50 bg-blue-600 hover:bg-blue-700 w-32 flex justify-center rounded-lg bg-primary/20 dark:bg-primary/30 py-2 px-4 text-l font-medium text-primary shadow-sm hover:bg-primary/30 dark:hover:bg-primary/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary" : "focus:outline-none transition-colors disabled:opacity-50 hover:bg-blue-300 w-32 flex justify-center rounded-lg py-2 px-4 text-l font-medium text-muted-light hover:text-primary shadow-sm hover:bg-primary/15 dark:hover:bg-primary/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"}>Raports</NavLink>
        </nav>
